...
public class Player {
    ...
    public int getDamage() {
        ...
        if (weapon != null) {
            d += weapon.getDamage();
            if (hasItem("Rail-Accelerator") && weapon.getName().equalsIgnoreCase("Rail-Gun")) {
                d += 5;
            } else if (hasItem("Blade-Enhancer") && weapon.getName().equalsIgnoreCase("Plasma-Blade")) {
                d += 5;
            } else if (hasItem("Ion-Amplifier") && weapon.getName().equalsIgnoreCase("Ion-Cannon")) {
                d += 5;
            }
        } else {
            d = 5;
