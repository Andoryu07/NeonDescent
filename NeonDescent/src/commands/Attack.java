...
public class Attack extends Command {
    ...
    public String execute(MapState mapS, Player player) {
        ...
        if (n != null) {
            ...
            if (n.getHealth() <= 0) {
                ...
                line = "You've damaged " + n.getName() + ". Remaining integrity: " + n.getHealth() + ".";
            ...
            line = "Target not found in this sector";
        }
        return line;
    }
    ...
    private String killDescription(NPC n, ArrayList<Item> items) {
        String line = "You've terminated " + n.getName() + ".";
        if (!items.isEmpty()) {
            line += " He dropped ";
        ...
        if (n.getName().equalsIgnoreCase("APEX")) {
            line += """
            
            A shimmering evacuation portal flickers open—emergency protocol activated.
            "My work here is done. Time to leave this digital hell," Kai muttered, diving through the portal.""";
            dead = true;
        }
        return line;
    }
